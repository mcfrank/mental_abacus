...
function addition_addends

home
fprintf('Addition with variable addends.\n\n');
...
while GetSecs - start_time < settings.experiment_time_limit;
  ...
  % digits
  settings.qs{i} = getManyDigits(settings.num_digits(i),2);
  ...
  save(['data/' subnum '-ADD-ADDENDS.mat'],'correct','settings','resp','rt1','rt2');

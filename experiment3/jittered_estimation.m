...
function jittered_estimation(subnum)

cd ~/Desktop/abacus/jittercards
...
while GetSecs - start_time < settings.experiment_time_limit;
  ...
  drawAbacusArrayJittered(ws,settings,settings.q(i));
  ...
  save(['data/' num2str(subnum) '-JITC.mat'],'settings','resp','rt1','rt2');
